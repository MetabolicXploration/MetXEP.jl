...
# function eponesweep!(epmodel::FluxEPModel)
#     @extract epmodel : epfields epalg epmat
#     @assert epmat isa EPMat
...
#     # Σ = inv(Σ^-1)
#     elapsed_eponesweep_inv = @elapsed inplaceinverse!(Σ, Σ⁻¹)
#     config!(epmodel; elapsed_eponesweep_inv)
